...
var require_glob_slash = __commonJS({
  "node_modules/serve-handler/src/glob-slash.js"(exports2, module2) {
    var path = require("path");
    var normalize = (value) => path.posix.normalize(path.posix.join("/", value));
    module2.exports = (value) => value.charAt(0) === "!" ? `!${normalize(value.substr(1))}` : normalize(value);
...
// node_modules/serve-handler/node_modules/mime-db/db.json
var require_db = __commonJS({
  "node_modules/serve-handler/node_modules/mime-db/db.json"(exports2, module2) {
    module2.exports = {
...
// node_modules/serve-handler/node_modules/mime-db/index.js
var require_mime_db = __commonJS({
  "node_modules/serve-handler/node_modules/mime-db/index.js"(exports2, module2) {
...
var require_mime_types = __commonJS({
  "node_modules/serve-handler/node_modules/mime-types/index.js"(exports2) {
    "use strict";
...
var require_directory = __commonJS({
  "node_modules/serve-handler/src/directory.js"(exports2, module2) {
    (function() {
      ...
      var itself = directory, _encodeHTML = /* @__PURE__ */ function(doNotSkipEncoded) {
        var encodeHTMLRules = { "&": "&#38;", "<": "&#60;", ">": "&#62;", '"': "&#34;", "'": "&#39;", "/": "&#47;" }, matchHTML = doNotSkipEncoded ? /[&<>"'\/]/g : /&(?!#?\w+;)|<|>|"|'|\//g;
        return function(code) {
          return code ? code.toString().replace(matchHTML, function(m) {
            return encodeHTMLRules[m] || m;
...
var require_error = __commonJS({
  "node_modules/serve-handler/src/error.js"(exports2, module2) {
    (function() {
      function error(it) {
      ...
      var itself = error, _encodeHTML = /* @__PURE__ */ function(doNotSkipEncoded) {
        var encodeHTMLRules = { "&": "&#38;", "<": "&#60;", ">": "&#62;", '"': "&#34;", "'": "&#39;", "/": "&#47;" }, matchHTML = doNotSkipEncoded ? /[&<>"'\/]/g : /&(?!#?\w+;)|<|>|"|'|\//g;
        return function(code) {
          return code ? code.toString().replace(matchHTML, function(m) {
            return encodeHTMLRules[m] || m;
...
var require_src = __commonJS({
  "node_modules/serve-handler/src/index.js"(exports2, module2) {
    var { promisify } = require("util");
    var path = require("path");
    var { createHash } = require("crypto");
    var { realpath, lstat, createReadStream, readdir } = require("fs");
    ...
    var isPathInside = require_path_is_inside();
    var parseRange = require_range_parser();
    var directoryTemplate = require_directory();
    var errorTemplate = require_error();
    var etags = /* @__PURE__ */ new Map();
    var calculateSha = (handlers, absolutePath) => new Promise((resolve, reject) => {
    ...
    var toTarget = (source, destination, previousPath) => {
    ...
    var applyRewrites = (requestPath, rewrites = [], repetitive) => {
    ...
    var ensureSlashStart = (target) => target.startsWith("/") ? target : `/${target}`;
    var shouldRedirect = (decodedPath, { redirects = [], trailingSlash }, cleanUrl) => {
    ...
    var appendHeaders = (target, source) => {
      for (let index = 0; index < source.length; index++) {
        const { key, value } = source[index];
        target[key] = value;
      }
    };
    var getHeaders = async (handlers, config, current, absolutePath, stats) => {
    ...
    var applicable = (decodedPath, configEntry) => {
    ...
    var renderDirectory = async (current, acceptsJSON, handlers, methods, config, paths) => {
    ...
    var sendError = async (absolutePath, response, acceptsJSON, current, handlers, config, spec) => {
...
var import_serve_handler = __toESM(require_src());
var import_promises = require("fs/promises");
var dataFile = "./data.json";
var getBody = (req) => new Promise((resolve) => {
  let body = "";
  req.on("data", (chunk) => {
    body += chunk;
  });
...
var server = (0, import_http.createServer)(async (req, res) => {
  ...
  if (url.pathname === "/data") {
    if (req.method === "GET") {
      ...
      try {
        res.write(await (0, import_promises.readFile)(dataFile, "utf-8"));
      } catch (e) {
        console.log(e);
      ...
      let current = [];
      try {
        current = JSON.parse(await (0, import_promises.readFile)(dataFile, "utf-8"));
      } catch (e) {
        console.log(e);
      }
      current.push(JSON.parse(body));
      await (0, import_promises.writeFile)(dataFile, JSON.stringify(current));
      res.statusCode = 200;
      res.end();
      return;
    }
